...
/*
this is the Duck.java file it is the Duck class.
It extends from the Animal class so it is a child of the parent class Animal, or a subclass of superclass Animal.
It has an overrided sound() method from Animal class that specifically calls quack rather than being depended on data type passed
*/
